...
# Conclusion
```{r}
# Standard factors that a manager may believe to drive cancellation (e.g. hotel type, children/no children) actually show little to no impact on cancellation rates. Rather, the largest indicator is the customers' history in booking/cancelling behavior. 
